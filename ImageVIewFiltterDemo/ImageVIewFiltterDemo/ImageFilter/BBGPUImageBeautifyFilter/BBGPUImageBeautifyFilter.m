...
@implementation BBGPUImageBeautifyFilter
...
- (id)init;
{
    ...
    //美颜程度
    combinationFilter.intensity = 0.5;
...
- (void)setBrightness:(CGFloat)brightness {
    ...
    [hsbFilter adjustSaturation:self.saturation];
}
- (void)setSaturation:(CGFloat)saturation {
    ...
    [hsbFilter adjustBrightness:self.brightness];
